...
import com.example.cartshop.Model.Product;
...
public class ProductsDetailFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        priceview.setText("Precio por unidad es de $" + String.valueOf(price));
        ...
        addquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                priceview.setText("El total por "  + String.valueOf(quantity) +" unidades es de " + "$"+String.valueOf(finalprice));
...
/*    private void HistoryCart() {
        ...
        firestore.collection("CartHistory").document(title).set(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
